var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		var video1 = new AR.VideoDrawable("assets/out_p1.mp4", 0.7, {
			offsetX: 0.5,
			offsetY: 0.12,
			isTransparent: true
		});

		var video2 = new AR.VideoDrawable("assets/out_p2.mp4", 0.7, {
			offsetX: 0.5,
			offsetY: 0.12,
			isTransparent: true
		});
		var video3 = new AR.VideoDrawable("assets/out_p3.mp4", 0.7, {
			offsetX: 0.5,
			offsetY: 0.12,
			isTransparent: true
		});
...
/*		this.imgButton = new AR.ImageResource("assets/wwwButton.jpg");
		...
		*/
		var page1 = new AR.Trackable2DObject(this.tracker, "step1", {
			drawables: {
				cam: [video1]
			},
			onEnterFieldOfVision: function onEnterFieldOfVisionFn() {
				...
				e.innerHTML = "Please choose your language";
			},
		...
		var page2 = new AR.Trackable2DObject(this.tracker, "step2", {
			drawables: {
				cam: [video2]
			},
			onEnterFieldOfVision: function onEnterFieldOfVisionFn() {
				video2.resume();
				var e = document.getElementById('loadingMessage');
                e.innerHTML = "You can choose below option to checkin";
			},
			onExitFieldOfVision: function onExitFieldOfVisionFn() {
				video2.pause();
				var e = document.getElementById('loadingMessage');
		...
		var page3 = new AR.Trackable2DObject(this.tracker, "step3", {
			drawables: {
				cam: [video3]
			},
			onEnterFieldOfVision: function onEnterFieldOfVisionFn() {
				video3.resume();
				var e = document.getElementById('loadingMessage');
				e.innerHTML = "Please enter your booking code or ticket number";
			},
			onExitFieldOfVision: function onExitFieldOfVisionFn() {
				video3.pause();
				var e = document.getElementById('loadingMessage');
