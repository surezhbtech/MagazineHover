package com.klm.magazine.magazinehover.urllauncher;
...
import com.klm.magazine.magazinehover.R;
	...
	protected void onCreate( final Bundle savedInstanceState ) {
		...
		buttonVisitUrl.setOnClickListener( new View.OnClickListener() {
			...
			public void onClick( final View arg0 ) {
				...
				if ( ContextCompat.checkSelfPermission(ARchitectUrlLauncherActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED ) {
					ActivityCompat.requestPermissions(ARchitectUrlLauncherActivity.this, new String[]{Manifest.permission.CAMERA}, WIKITUDE_PERMISSIONS_REQUEST_CAMERA);
				} else {
